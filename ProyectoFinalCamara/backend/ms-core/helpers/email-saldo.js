...
import { sendViaBrevo } from './brevo-client.js';
...
export const sendVerificacionTarjeta = async ({
  ...
  try {
    ...
    console.warn('SMTP no configurado o error — correo de verificación no enviado:', error.message);
  }
};
...
export const sendAlertaTarjetaAgregada = async ({
  ...
  try {
    ...
    console.warn('Error enviando correo de tarjeta activada:', error.message);
  }
};
...
export const sendAlertaRecarga = async ({
  ...
  try {
    ...
    console.warn('Error enviando correo de recarga:', error.message);
  }
};