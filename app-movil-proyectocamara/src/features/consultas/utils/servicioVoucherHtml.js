// src/features/consultas/utils/servicioVoucherHtml.js
export const buildServicioVoucherHtml = ({
  servicioLabel,
  concepto,
  referencia,
  monto,
...
<html>
  <head>
    ...
    <style>
      ...
      .amount .value { font-size: 32px; color: #0EA5A5; }
      .footer { text-align: center; margin-top: 24px; color: #94a3b8; font-size: 11px; }
    </style>
  </head>
  <body>
    <div class="header">
      <h1>Comprobante de Pago — ${servicioLabel}</h1>
    ...
    <div class="box">
      <div class="row"><span class="label">Titular</span><span class="value">${titular || "—"}</span></div>
